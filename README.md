...
3. Start working on the rule
    ...
    2. Comment the rule:
        ...
        2. Each private methods should be commented and explain their behavior.
    3. Create the Unit Tests for the rule or create a task on Trello to remind to do it.
        1. If you create the unit tests:
            - Comment every test with a clear way of what you're testing and what you're expecting.
        2. If you create a task on Trello
            - Comment the task and provide each edge cases the rule should cover and their expectations
4. Make a PR
